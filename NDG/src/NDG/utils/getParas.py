class Paras():
    ...
    def set_evaluation(self):
        ...
        elif self.problem == 'hicnet':
            self.eva_timeout = 100
        elif self.problem == 'tsp_construct':
            self.eva_timeout = 20
        elif self.problem == 'butter':
            self.eva_timeout = 60  # 设置适当的超时时间
        elif self.problem == 'cora':
            self.eva_timeout = 240  # 设置适当的超时时间
        elif self.problem == 'dream':
            self.eva_timeout = 600
        elif self.problem == 'mc':
            self.eva_timeout = 90
